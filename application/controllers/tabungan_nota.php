...
function cetak_nota() {
	$tabungan = $this->tabungan_m->lap_data_tabungan();
	$jml_tabungan = $this->tabungan_m->get_jml_tabungan();
        ...
        $html .= '
            ...
            '.$pdf->nsi_box($text = '<span class="txt_judul">Laporan Data tabungan Anggota <br></span>', $width = '100%', $spacing = '0', $padding = '1', $border = '0', $align = 'center').'
            ...
            <th class="h_tengah" style="width:20%;"> Jenis Tabungan </th>
        ...
        $html .= '
        <tr class="header_kolom"><td colspan="5"> Jumlah Total </td><td class="h_kanan"> '.number_format($jml_tabungan->jml_total).'</td><td></td></tr>
