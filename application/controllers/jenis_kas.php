...
class Jenis_kas extends AdminController {
	...
	public function index() {
		...
		$crud->columns('nama', 'aktif', 'tmpl_simpan', 'tmpl_penarikan', 'tmpl_penarikan_tb', 'tmpl_pinjaman', 'tmpl_bayar','tmpl_pemasukan','tmpl_pengeluaran','tmpl_transfer');
		$crud->fields('nama', 'aktif', 'tmpl_simpan', 'tmpl_penarikan','tmpl_penarikan_tb', 'tmpl_pinjaman', 'tmpl_bayar','tmpl_pemasukan','tmpl_pengeluaran','tmpl_transfer');
	
		$crud->display_as('nama','Nama Kas');
		$crud->display_as('tmpl_simpan','Simpanan');
		$crud->display_as('tmpl_penarikan','Penarikan');
		$crud->display_as('tmpl_penarikan_tb','Penarikan_tb');
