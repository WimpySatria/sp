...
class Simpanan extends OperatorController {
	...
	function get_jumlah_simpanan() {
		...
		$jumlah = $this->simpanan_m->get_jumlah($jenis_id, $no_rek);
	...
	function get_no_rek() {
		...
		$jenis_id = $this->input->post('jenis_id');
		$no_rek = $this->simpanan_m->get_no_rek($anggota_id, $jenis_id);
	...
	function cetak_laporan() {
		...
		$simpanan = $this->simpanan_m->lap_data_simpanan($search,$sort,$order);
// 		print_r($simpanan);
// 		die();
		if($simpanan == FALSE) {
			//redirect('simpanan');
		...
		'.$pdf->nsi_box($text = '<span class="txt_judul">Laporan Data Setoran Simpanan <br></span>
