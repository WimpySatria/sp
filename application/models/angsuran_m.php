...
class Angsuran_m extends CI_Model {
	...
	public function create() {
		...
		$bayar_pokok = str_replace(',', '', $this->input->post('bayar_pokok')) * 1;
		$bayar_bunga = str_replace(',', '', $this->input->post('bayar_bunga')) * 1;
		$denda= str_replace(',', '', $this->input->post('denda_val'))*1;
		$jumlah_bayar = $bayar_pokok + $bayar_bunga + $denda;
		$data = array(			
						...
						'bayar_pokok'	=>	str_replace(',', '', $this->input->post('bayar_pokok')),
						'bayar_bunga'	=>	str_replace(',', '', $this->input->post('bayar_bunga')),
						'denda_rp'		=>	$denda,
						'ket_bayar'		=>	'Angsuran',
