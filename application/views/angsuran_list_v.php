...
<thead>
	<tr>
		...
		<th data-options="field:'bayar_pokok', width:'20', halign:'center', align:'right'">Bayar Pokok</th>

		<th data-options="field:'bayar_bunga', width:'20', halign:'center', align:'right'">Bayar Bunga</th>
...
<div id="dialog-form" name="aoutoSumForm" class="easyui-dialog" modal="true" show="blind" hide= "blind" resizable="false" style="width:400px; height:400px; padding: 20px 20px" closed="true" buttons="#dialog-buttons" style="display: none;">
	<form id="form" method="post" novalidate>
		<table>
			...
			<tr style="height:30px">
				<td> Bayar Pokok</td>
				<td> : </td>
				<td> <input type="text" class="easyui-numberbox" id="bayar_pokok" name="bayar_pokok" data-options="precision:0,groupSeparator:',',decimalSeparator:'.'" value=""/>
			...
			<tr style="height:30px">
				<td> Bayar Bunga</td>
				<td> : </td>
				<td> <input type="text" class="easyui-numberbox" id="bayar_bunga" name="bayar_bunga" data-options="precision:0,groupSeparator:',',decimalSeparator:'.'" value="" />
			...
			<tr style="height:30px">
				...
				<td> : </td>
				<td>
				    <!-- <div class="inputform"><?php echo number_format((nsi_round($row_pinjam->ags_per_bulan))); ?></div> -->
					<!--<span type="text" id="angsuran" name="angsuran"   /> -->
					<input type="text" id="angsuran" name="angsuran"  data-options="precision:0,groupSeparator:',',decimalSeparator:'.'"/>

				
				</td>
			</tr>

			<!-- Akhir Bayar Angsuran -->
			...
			<tr style="height:30px">
				...
				<td> :</td>
				<td>
					<select id="kas_id" name="kas_id" style="width:200px; height:23px" class="easyui-validatebox">
...
<!-- <script type="text/javascript" src="<?= base_url(); ?>/assets/theme_admin/js/jquery.min.js"></script> -->
