		...
		<div class="box box-primary">
			<div class="box-body" style="min-height: 500px;">
				...
				<table 
					...
					data-toggle="table"
					data-id-field="id"
					data-url="<?php echo site_url('spk/pengajuan_ajax_list'); ?>" 
					...
					<thead>
						<tr>
							...
							<th data-field="tgl_input_txt" data-sortable="true" data-valign="middle" data-align="center" data-halign="center" data-formatter="tgl_input_ft">Tanggal</th>

							<th data-field="ketua" data-sortable="true" data-valign="middle" data-align="left" data-halign="center" data-formatter="ketua_ft">Ketua</th>

							<th data-field="anggota" data-sortable="true" data-valign="middle" data-align="left" data-halign="center" data-formatter="anggota_ft">Anggota</th>
							

							<th data-field="jml_pinjam" data-sortable="true" data-valign="middle" data-align="right" data-halign="center" data-formatter="jml_pinjan_ft">Jumlah</th>

							<th data-field="lama_ags" data-sortable="true" data-valign="middle" data-align="center" data-halign="center" data-formatter="lama_ags_ft" >Bln</th>

							<th data-field="alamat" data-sortable="true" data-valign="middle" data-align="center" data-halign="center" data-formatter="alamat_ft" >Alamat</th>

							<th data-field="alasan" data-sortable="true" data-align="left" data-halign="center" data-valign="middle" data-formatter="alasan_ft">Alasan</th>
		
							<th data-field="user" data-sortable="true" data-align="left" data-halign="center" data-valign="middle" data-formatter="user_ft">Pengaju</th>
							...
							<!-- <th data-field="sisa_pinjaman" data-sortable="false" data-align="left" data-halign="center" data-valign="middle" data-formatter="sisa_ft" hidden="true">Sisa Pinjaman</th> -->
...
<script type="text/javascript">
	...
	$(function() {
		...
		$table.on('click', '.a_diterima, .a_ditolak, .a_dipending, .a_hapus, .a_dilaksanakan, .a_belum, .a_dibatal', function(event) {
			...
			} else if(data_aksi == 'Tolak') {
				$('#div_alasan').show();
						$('#div_alasan').html(`<div id="div_alasan_input" class="form-group">
						<label>Alasan:</label>
						<input type="text" name="alasan" id="alasan" class="form-control" value=""></input></div>`)
			}else{

				// ajax untuk mengambil data bunga

				$.ajax({
					url : "<?=base_url('pengajuan/get_bunga')?>",
					dataType : "JSON",
					success : function(hasil){
						$('#div_alasan').show();
						$('#div_alasan').html(`<div id="div_alasan_input" class="form-group">
						<label>Alasan:</label>
						<input type="text" name="alasan" id="alasan" class="form-control" value=""></input>
						<label>Bunga:</label>
						<select name="bunga" id="bunga" class="form-control">
						 <option value="0"> Tetapkan Bunga <option>
						</select>
						</div>` + fm_tgl_cair);
						$.each(hasil, function(i, data){
							$('#bunga').append('<option value="'+data.opsi_val+'">'+data.opsi_val+'</option>')
		...
		$('#link_konfirmasi').click(function(event) {
			...
			var data_bunga = $('#bunga').val();
			var data_tgl_cair = $('#tgl_cair').val();
			$.ajax({
				url: '<?php echo site_url('pengajuan/aksi'); ?>',
				type: 'POST',
				dataType: 'html',
				data: {id: data_id, aksi: data_aksi, tgl_cair: data_tgl_cair, alasan: data_alasan, bunga:data_bunga},
			})
			.done(function(data) {
				if(data == 'OK') {
