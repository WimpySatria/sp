...
<body>
	...
	<div class="container">
	<div class="row">
		<h2 class="text-center text-primary mb-2">Setoran</h2>
	</div>
		<div class="row">
			...
			<div class="form-group">
                <label class="control-label " for="email">Jumlah Setoran:</label>
			...
			<button type="submit" name="setoran" class="btn btn-primary">Simpan</button>
